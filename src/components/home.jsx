...
const Home = () => {
  ...
  return (
    ...
    <motion.div className={darkMode ? "dark":""} initial={{opacity:0}} animate={{opacity:1}} transition={{duration:1.6, delay: 0.5}}>
      ...
      <section className='text-gray-700 border-t border-gray-200 h-screen'id='about'>




        <motion.div className='container px-5 py-5 mx-auto' ref={ref} variants={scrollcomponets}  initial="hidden" animate={control} >
      ...
      <section className='text-gray-700 border-t border-gray-200 py-5 h-screen'id='skills'>
        ...
        {/*スキルのdivタグ   */}
        <motion.div className='flex flex-wrap  scroll-smooth hover:scroll-auto ' ref={ref} variants={scrollcomponets}  initial="hidden" animate={control}>
